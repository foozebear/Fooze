...
- (void)applyDefaults
{
    ...
    if (screenSize.height == 568.) {
        ...
        self.titlePositionY  = 200.0f;
        self.descPositionY   = 160.0f;
        self.titleFont = [UIFont fontWithName:FONTSTYLE size:25.0];
        self.titleColor = [UIColor blackColor];
        self.descFont = [UIFont fontWithName:FONTSTYLE size:14.0];
        self.descColor = [UIColor blackColor];
    }
    else {
        self.imgPositionY    = 50.0f;
        self.titlePositionY  = 180.0f;
        self.descPositionY   = 150.0f;
        self.titleFont = [UIFont fontWithName:FONTSTYLE size:20.0];
        self.titleColor = [UIColor blackColor];
        self.descFont = [UIFont fontWithName:FONTSTYLE size:14.0];
        self.descColor = [UIColor blackColor];
    }

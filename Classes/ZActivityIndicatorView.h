...
/**
 The activity indicator view style. Default is `ZActivityIndicatorViewStyleNormal`.
 */
@property (nonatomic, assign) ZActivityIndicatorViewStyle activityIndicatorViewStyle;

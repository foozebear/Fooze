...
- (void)showSuccessWithImage:(NSString *)title image:(UIImage *)image color:(UIColor *)color subTitle:(NSString *)subTitle closeButtonTitle:(NSString *)closeButtonTitle duration:(NSTimeInterval)duration; //CPT

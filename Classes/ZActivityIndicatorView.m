//
//  ZActivityIndicatorView.m
//  ZActivityIndicatorView
//
//  Created by Cris Padilla Tagle on 12/27/14.
//  Copyright (c) 2014 Zynappse Corporation. All rights reserved.
//

#import "ZActivityIndicatorView.h"

@interface ZActivityIndicatorView ()
...
@implementation ZActivityIndicatorView
...
- (void)setActivityIndicatorViewStyle:(ZActivityIndicatorViewStyle)activityIndicatorViewStyle
{
    ...
    switch (_activityIndicatorViewStyle) {
        case ZActivityIndicatorViewStyleNormal:
            backgroundImageName = @"spinner_background";
            indicatorImageName = @"spinner";
            break;
        case ZActivityIndicatorViewStyleLarge:
            backgroundImageName = @"spinner_background-large";
...
- (id)initWithActivityIndicatorStyle:(ZActivityIndicatorViewStyle)style
{
